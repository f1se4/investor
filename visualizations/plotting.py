...
# Supongamos que tienes una función calculate_macd que devuelve las líneas macd_line y signal_line
def calculate_macd(data):
    # Esta es una función ficticia, sustituye esto con tu cálculo real de MACD y Signal
...
def plot_indicators_macd(data):
    ...
    # Calcula MACD y Signal
    macd_line, signal_line = calculate_macd(data)

    # Añadir MACD y Signal
    ...
    # Identificar las áreas donde MACD está por encima de Signal
    above_mask = macd_line > signal_line

    # Crear trazas para las áreas donde MACD está por encima de Signal
    fig.add_trace(go.Scatter(
        x=data.index[above_mask], 
        y=macd_line[above_mask], 
        fill=None, 
        mode='lines', 
        line=dict(width=0)
    ), row=1, col=1)
...
def plot_indicators_macd(data):
    ...
    # Pintar solo el área donde MACD está por encima de Signal
    fig.add_trace(go.Scatter(
        x=data.index, 
        y=macd_line, 
        mode='lines', 
